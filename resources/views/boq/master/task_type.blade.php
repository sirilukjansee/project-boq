                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body p-10">
                                            ...
                                            <form action="{{ url('/masterTaskType/add') }}" method="post">
                                                @csrf
                                                <div class="form-group mb-4">
                                                    <input type="text" class="form-control mb-2" name="task_type_name" placeholder="Task Type" required>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-10">
                                        ...
                                        <form action="{{ url('/masterTaskType/update') }}" method="post">
                                            @csrf
                                            <div class="form-group mb-4">
                                                <input type="hidden" name="id" id="get_id">
                                                <input type="text" class="form-control mb-2" name="task_type_name" id="task_type_name" placeholder="ชื่องาน" value="">
