                ...
                <div class="content">
                    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                        ...
                        {{-- <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                            <a href="{{ url("add_masterBoq") }}" class="btn btn-primary shadow-md mr-2"><i data-lucide="plus" class="w-4 h-4 mr-2"></i> Add Master </a>
                        </div> --}}
                    </div>
                    ...
                    <div class="intro-y box p-5 mt-5">
                        ...
                        <form action="" method="POST">
                            <div class="p-4 mb-4">
                                ...
                                <select id="select-beast" placeholder="Select a person..." autocomplete="off" class="w-1/2">
                            ...
                            <div class="">
                                ...
                                <a href="{{ url('masterBoq') }}" class="btn btn-secondary"> Back </a>
                            </div>
                        </form>
                    </div>
                    <!-- END: HTML Table Data -->
