                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body p-10">
                                            ...
                                            <form action="{{ url('/masterBrand/add') }}" method="post">
                                                @csrf
                                                <div class="form-group mb-4">
                                                    <input type="text" class="form-control mb-2" name="brand_name" placeholder="Brand_name" required>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <!-- BEGIN: Large Modal Toggle -->
                                            <a href="javascript:;" data-tw-toggle="modal" onclick="edit_modal({{ $brd->id }})" data-tw-target="#large-modal-size-preview_edit" class="btn btn-secondary mr-1 edit">Edit</a>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body p-10">
                                        ...
                                        <form action="{{ url('/masterBrand/update') }}" method="post">
                                            @csrf
                                            <div class="form-group mb-4">
                                                <input type="hidden" name="id" id="get_id">
                                                <input type="text" class="form-control mb-2" name="brand_name" id="brand_name" placeholder="Brand_name" value="">
